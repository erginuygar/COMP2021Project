...
public final class ClevisTest {
    ...
    public void testDuplicateNameError() {
        ...
        String actual = outContent.toString().trim();
        String expected = "Error: name already used";
    ...
    public void testInvalidNumberFormat() {
        ...
        String actual = outContent.toString().trim();
        String expected = "Error: invalid number format.";
    ...
    public void testREQ11_ShapeAt() {
        ...
        String actual = outContent.toString().trim();
        String expected = "Topmost shape at (2.00,2.00): at1";
